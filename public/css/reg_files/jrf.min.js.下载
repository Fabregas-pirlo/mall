...
JRF.win = window;
JRF.top = window.top;
JRF.curr_domain = document.domain;
JRF.curr_protocol = document.location.protocol;
JRF.curr_origin = document.location.origin;
// 必填项提示信息
...
JRF.login = function() {
	...
	$.confirm(loginTip, function(r) {
		if(r){
			window.location.href= document.location.protocol+"//"+locationDomain+"/r_member/login.jspx";
		}
	});
}
/**
